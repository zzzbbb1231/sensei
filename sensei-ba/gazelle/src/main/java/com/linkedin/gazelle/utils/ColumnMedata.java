...
public class ColumnMedata {
  ...
  public static HashMap<String, ColumnMedata> readFromFile(PropertiesConfiguration config) {
    HashMap<String, ColumnMedata> columnMetadataMap = new HashMap<String, ColumnMedata>();
