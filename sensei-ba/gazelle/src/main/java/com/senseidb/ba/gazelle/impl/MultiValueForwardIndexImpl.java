...
public class MultiValueForwardIndexImpl implements MultiValueForwardIndex {
    private final CompressedMultiArray compressedMultiArray;
    private final ColumnMetadata columnMetadata;
    private final TermValueList<?> dictionary;

    public MultiValueForwardIndexImpl(String column, CompressedMultiArray compressedMultiArray, TermValueList<?> dictionary, ColumnMetadata columnMetadata) {
