    ...
    if (columns != null) {
      ...
      for (String column : columns) {
        ...
        if ((ratio > 100 || optionValue.equalsIgnoreCase("standard")) && !optionValue.equalsIgnoreCase("high")) {
          ...
          // We estimate the jump value for one dictionary value and assume it
          // will work for the others (Otherwise, we waste too much time
        ...
        // If the size of the dictionary is too large, we create a specialized
        // GazelleInvertedIndexHighCardinalityImpl
        else {
