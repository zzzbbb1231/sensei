...
public class InvertedIndexOptionTest extends TestCase {
  ...
  public void setUp() throws Exception {
    ...
    File ConfDir1 = new File(BASegmentRecoverTest.class.getClassLoader().getResource("ba-conf-inverted").toURI());
